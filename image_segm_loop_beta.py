...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.conv2 = SAGEConv(16, data.num_classes, normalize = True)
...
main_dir = 'C:\\Users\\an_fab\\Desktop\\graph_segm\\test'

#dir_gt = 'C:\\Users\\an_fab\\Desktop\\graph_segm\\microsoft'+'\\gt\\'
dir_img = 'C:\\Users\\an_fab\\Desktop\\graph_segm\\test'+'\\org\\'
dir_results = 'C:\\Users\\an_fab\\Desktop\\graph_segm\\test'+'\\results\\'
dir_scrib = 'C:\\Users\\an_fab\\Desktop\\graph_segm\\test'+'\\scribbles\\'
...
for name in glob.glob(dir_img+'/*'):
    ...
    #img = 255*filters.gaussian(img, sigma = 0.05, multichannel=True)
    ...
    while beta < 5000:
                    ...
                    #data = GraphFromImage(img, 0, beta, 0, 0, 0)
                    data = GraphFromImage(img, beta)
                    print(data)
